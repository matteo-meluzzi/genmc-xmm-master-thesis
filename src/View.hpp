...
public:
	...
	/* Cuts the view to e (i.e. sets the last seen event in the e.thread to the e.index) */
	View& cut(const Event e);
	...
	// TODO: a more consistent and efficient implementation of the partial order operators?
	inline bool operator==(const View &v) const {
		auto sz = std::max(size(), v.size());
